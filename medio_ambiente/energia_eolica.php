...
<head>
    ...
    <title><?php echo $lang["titulo_energiaeolica"] ?></title>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2" class="text-center">
                                    <h1><?php echo $lang["titulo_energiaeolica"] ?> <i class="fas fa-fan"></i></h1>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <img src="img/Energía_Eólica_sin_Cielo.png" alt="engsol" style="width: 250px;">
                                </td>
                                <?php
                                if ($detect->isMobile()) {
                                ?>
                            ...
                            <td>
                                <label class="text-justify">
                                    <?php echo $lang["energiaeolica_label"] ?>
                                </label>
                                <br>
                                <label>
                                    <?php echo $lang["energiaeolica_ventajas"] ?>
                                    <br>
                                    <ul>
                                        <li><?php echo $lang["energiaeolica_ventaja_1"] ?></li>
                                        <li><?php echo $lang["energiaeolica_ventaja_2"] ?></li>
                                        <li><?php echo $lang["energiaeolica_ventaja_3"] ?></li>
                                        <li><?php echo $lang["energiaeolica_ventaja_4"] ?></li>
                                        <li><?php echo $lang["energiaeolica_ventaja_5"] ?></li>
                                        <li><?php echo $lang["energiaeolica_ventaja_6"] ?></li>
                                    </ul>
                                </label>
                            </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="text-center">
                                    <h1><?php echo $lang["energiaeolica_video"] ?></h1>
                                </td>
                            </tr>
                            <!--Español-->
                            <tr>
                                <td colspan="2" class="text-center">
                                    <iframe width="600" height="400" src="https://youtube.com/embed/0DF6r6XOqKg">
                                    </iframe>
                                </td>
                            </tr>
                        </tbody>
