...
<head>
    ...
    <title><?php echo $lang["titulo_autoelectrico"] ?></title>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="energia_solar.php"><i class="fas fa-solar-panel"></i> <?php echo $lang["menu_ambiente_solar"] ?></a>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2" class="text-center">
                                    <h1><?php echo $lang["titulo_autoelectrico"] ?> <i class="fas fa-charging-station"></i></h1>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <img src="img/auto_electrico.png" alt="engsol" style="width: 400px;">
                                </td>
                                <?php
                                if ($detect->isMobile()) {
                                ?>
                            ...
                            <td>
                                <label class="text-justify">
                                    <?php echo $lang["autoelectrico_label"] ?>
                                </label>
                                <br>
                                <label>
                                    <?php echo $lang["autoelectrico_ventajas"] ?>
                                    <br>
                                    <ul>
                                        <li><?php echo $lang["autoelectrico_ventaja_1"] ?></li>
                                        <li><?php echo $lang["autoelectrico_ventaja_2"] ?></li>
                                        <li><?php echo $lang["autoelectrico_ventaja_3"] ?></li>
                                        <li><?php echo $lang["autoelectrico_ventaja_4"] ?></li>
                                        <li><?php echo $lang["autoelectrico_ventaja_5"] ?></li>
                                    </ul>
                                </label>
                            </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="text-center">
                                    <h1><?php echo $lang["autoelectrico_video"] ?></h1>
                                </td>
                            </tr>
                            <!--Español-->
                            <tr>
                                <td colspan="2" class="text-center">
                                    <iframe width="600" height="400" src="https://youtube.com/embed/tF4p3qDRUdY">
                                    </iframe>

                                    <iframe width="600" height="400" src="https://youtube.com/embed/7gFoL8KhcIM">
                                    </iframe>
                                </td>
                            </tr>
                            <!--Español-->
                            <tr>
                                <td colspan="2" class="text-center">
                                    <iframe width="600" height="400" src="https://youtube.com/embed/xQxJxRT0TWo">
                                    </iframe>
                                </td>
                            </tr>
                        </tbody>
